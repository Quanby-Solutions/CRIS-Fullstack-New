  ...
  try {
    ...
    const updatedForm = await prisma.baseRegistryForm.update({
      ...
      data: {
        ...
        bookNumber,
        remarks,
        // For relation fields like 'preparedBy' on the base form, update them separately if needed.
        // Here we assume you do not update the relation.
        ...
        birthCertificateForm: {
          upsert: {
            update: {
              ...
              fatherAge: fatherInfo?.age ? Number(fatherInfo.age) : 0,
