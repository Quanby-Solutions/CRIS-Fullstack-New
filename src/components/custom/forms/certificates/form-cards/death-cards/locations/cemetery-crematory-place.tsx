...
const CemeteryOrCrematoryCards = () => {
  const {
    control,
    setValue,
    watch,
  ...
  useEffect(() => {
    const currentCountry = watch("cemeteryOrCrematory.address.country");
    if (!currentCountry) {
      setValue("cemeteryOrCrematory.address.country", "Philippines");
    }
  }, [setValue, watch]);
  ...
  useEffect(() => {
    if (provinces.length > 0 && !initialized) {
      const currentProvince = getValues("cemeteryOrCrematory.address.province");
      const currentMunicipality = getValues(
        "cemeteryOrCrematory.address.cityMunicipality"
      );
      const currentBarangay = getValues("cemeteryOrCrematory.address.barangay");
  ...
  const handleProvinceSelection = (provinceName: string) => {
    ...
    setSelectedBarangay("");
    setValue("cemeteryOrCrematory.address.cityMunicipality", "");
    setValue("cemeteryOrCrematory.address.barangay", "");
    setBarangays([]);
  };
  ...
  const selectedCountry = watch("cemeteryOrCrematory.address.country");
    ...
    <>
              ...
              <Select
                ...
                onValueChange={(value) => {
                  ...
                  if (value !== "Philippines") {
                    setValue("cemeteryOrCrematory.address.province", "");
                    setValue(
                      "cemeteryOrCrematory.address.cityMunicipality",
                      ""
                    );
                    ...
                    setValue(
                      "cemeteryOrCrematory.address.internationalAddress",
                      ""
                    );
                  }
                }}
      ...
      {isPhilippines ? (
        <>
          ...
          <FormField
            control={control}
            name="cemeteryOrCrematory.address.province"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={control}
            name="cemeteryOrCrematory.address.cityMunicipality"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={control}
            name="cemeteryOrCrematory.address.barangay"
            render={({ field }) => (
              <FormItem>
        ...
        <FormField
          control={control}
          name="cemeteryOrCrematory.address.internationalAddress"
          render={({ field }) => (
            <FormItem>
      ...
      <FormField
        control={control}
        name="cemeteryOrCrematory.address.street"
        render={({ field }) => (
          <FormItem>
      ...
      <FormField
        control={control}
        name="cemeteryOrCrematory.address.residence"
        render={({ field }) => (
          <FormItem>
...
export default CemeteryOrCrematoryCards;
