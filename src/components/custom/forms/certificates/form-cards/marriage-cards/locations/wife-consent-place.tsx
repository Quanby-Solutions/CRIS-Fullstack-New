...
const WifeConsentPlace = () => {
  ...
  useEffect(() => {
    const currentCountry = watch("wifeConsentPerson.residence.country");
    if (!currentCountry) {
      setValue("wifeConsentPerson.residence.country", "Philippines");
    }
  }, [setValue, watch]);
  ...
  useEffect(() => {
    if (provinces.length > 0 && !initialized) {
      const currentProvince = getValues("wifeConsentPerson.residence.province");
      const currentMunicipality = getValues(
        "wifeConsentPerson.residence.cityMunicipality"
      );
      const currentBarangay = getValues("wifeConsentPerson.residence.barangay");
  ...
  const handleProvinceSelection = (provinceName: string) => {
    ...
    setSelectedBarangay("");
    setValue("wifeConsentPerson.residence.cityMunicipality", "");
    setValue("wifeConsentPerson.residence.barangay", "");
    setBarangays([]);
  };
  ...
  const selectedCountry = watch("wifeConsentPerson.residence.country");
    ...
    <>
              ...
              <Select
                ...
                onValueChange={(value) => {
                  ...
                  if (value !== "Philippines") {
                    setValue("wifeConsentPerson.residence.province", "");
                    setValue(
                      "wifeConsentPerson.residence.cityMunicipality",
                      ""
                    );
                    ...
                    setValue(
                      "wifeConsentPerson.residence.internationalAddress",
                      ""
                    );
                  }
                }}
      ...
      {isPhilippines ? (
        <>
          ...
          <FormField
            control={control}
            name="wifeConsentPerson.residence.province"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={control}
            name="wifeConsentPerson.residence.cityMunicipality"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={control}
            name="wifeConsentPerson.residence.barangay"
            render={({ field }) => (
              <FormItem>
        ...
        <FormField
          control={control}
          name="wifeConsentPerson.residence.internationalAddress"
          render={({ field }) => (
            <FormItem>
...
export default WifeConsentPlace;
