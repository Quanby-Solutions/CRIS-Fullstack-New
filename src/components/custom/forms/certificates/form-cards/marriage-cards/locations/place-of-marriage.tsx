...
const PlaceOfMarriageCard = () => {
  ...
  useEffect(() => {
    const currentCountry = watch("placeOfMarriage.country");
    if (!currentCountry) {
      setValue("placeOfMarriage.country", "Philippines");
    }
  }, [setValue, watch]);
  ...
  useEffect(() => {
    if (provinces.length > 0 && !initialized) {
      const currentProvince = getValues("placeOfMarriage.province");
      const currentMunicipality = getValues("placeOfMarriage.cityMunicipality");
      const currentBarangay = getValues("placeOfMarriage.barangay");
  ...
  const handleProvinceSelection = (provinceName: string) => {
    ...
    setSelectedBarangay("");
    setValue("placeOfMarriage.cityMunicipality", "");
    setValue("placeOfMarriage.barangay", "");
    setBarangays([]);
  };
  ...
  const selectedCountry = watch("placeOfMarriage.country");
  ...
  return (
    <>
              ...
              <Select
                ...
                onValueChange={(value) => {
                  ...
                  if (value !== "Philippines") {
                    setValue("placeOfMarriage.province", "");
                    setValue("placeOfMarriage.cityMunicipality", "");
                    setValue("placeOfMarriage.barangay", "");
                    setSelectedProvince("");
                    setSelectedMunicipality("");
                    ...
                    setValue("placeOfMarriage.internationalAddress", "");
                  }
                }}
              >
      ...
      {isPhilippines ? (
        ...
        <FormField
          control={control}
          name="placeOfMarriage.internationalAddress"
          render={({ field }) => (
            <FormItem>
...
export default PlaceOfMarriageCard;
