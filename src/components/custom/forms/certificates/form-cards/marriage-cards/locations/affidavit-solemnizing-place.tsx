...
const AffidavitOfSolemnizingAtPlaceSworn = () => {
  const {
    control,
    setValue,
    watch,
  ...
  useEffect(() => {
    const currentCountry = watch(
      "affidavitOfSolemnizingOfficer.dateSworn.atPlaceOfSworn.country"
    );
    if (!currentCountry) {
      setValue(
        "affidavitOfSolemnizingOfficer.dateSworn.atPlaceOfSworn.country",
  ...
  useEffect(() => {
    if (provinces.length > 0 && !initialized) {
      ...
      const currentMunicipality = getValues(
        "affidavitOfSolemnizingOfficer.dateSworn.atPlaceOfSworn.cityMunicipality"
      );
      const currentBarangay = getValues(
        "affidavitOfSolemnizingOfficer.dateSworn.atPlaceOfSworn.barangay"
      );
    ...
    <>
              ...
              <Select
                ...
                onValueChange={(value) => {
                  ...
                  if (value !== "Philippines") {
                    ...
                    setValue(
                      "affidavitOfSolemnizingOfficer.dateSworn.atPlaceOfSworn.internationalAddress",
                      ""
                    );
                  }
                }}
      ...
      {isPhilippines ? (
        <>
          ...
          <FormField
            control={control}
            name="affidavitOfSolemnizingOfficer.dateSworn.atPlaceOfSworn.province"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={control}
            name="affidavitOfSolemnizingOfficer.dateSworn.atPlaceOfSworn.cityMunicipality"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={control}
            name="affidavitOfSolemnizingOfficer.dateSworn.atPlaceOfSworn.barangay"
            render={({ field }) => (
              <FormItem>
        ...
        <FormField
          control={control}
          name="affidavitOfSolemnizingOfficer.dateSworn.atPlaceOfSworn.internationalAddress"
          render={({ field }) => (
            <FormItem>
      ...
      <FormField
        control={control}
        name="affidavitOfSolemnizingOfficer.dateSworn.atPlaceOfSworn.residence"
        render={({ field }) => (
          <FormItem>
...
export default AffidavitOfSolemnizingAtPlaceSworn;
