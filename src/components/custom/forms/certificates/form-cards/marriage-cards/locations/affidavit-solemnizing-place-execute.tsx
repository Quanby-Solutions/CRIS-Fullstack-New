...
const AffidavitOfSolemnizingAtPlaceExecute = () => {
  const {
    control,
    setValue,
    watch,
  ...
  useEffect(() => {
    const currentCountry = watch(
      "affidavitOfSolemnizingOfficer.d.atPlaceExecute.country"
    );
    if (!currentCountry) {
      setValue(
        "affidavitOfSolemnizingOfficer.d.atPlaceExecute.country",
  ...
  useEffect(() => {
    if (provinces.length > 0 && !initialized) {
      ...
      const currentMunicipality = getValues(
        "affidavitOfSolemnizingOfficer.d.atPlaceExecute.cityMunicipality"
      );
      const currentBarangay = getValues(
        "affidavitOfSolemnizingOfficer.d.atPlaceExecute.barangay"
      );
  ...
  const handleProvinceSelection = (provinceName: string) => {
    ...
    setValue("affidavitOfSolemnizingOfficer.d.atPlaceExecute.barangay", "");
    setBarangays([]);
  };
    ...
    <>
              ...
              <Select
                ...
                onValueChange={(value) => {
                  ...
                  if (value !== "Philippines") {
                    ...
                    setValue(
                      "affidavitOfSolemnizingOfficer.d.atPlaceExecute.internationalAddress",
                      ""
                    );
                  }
                }}
      ...
      {isPhilippines ? (
        <>
          ...
          <FormField
            control={control}
            name="affidavitOfSolemnizingOfficer.d.atPlaceExecute.province"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={control}
            name="affidavitOfSolemnizingOfficer.d.atPlaceExecute.cityMunicipality"
            render={({ field }) => (
              <FormItem>
          ...
          <FormField
            control={control}
            name="affidavitOfSolemnizingOfficer.d.atPlaceExecute.barangay"
            render={({ field }) => (
              <FormItem>
        ...
        <FormField
          control={control}
          name="affidavitOfSolemnizingOfficer.d.atPlaceExecute.internationalAddress"
          render={({ field }) => (
            <FormItem>
      ...
      <FormField
        control={control}
        name="affidavitOfSolemnizingOfficer.d.atPlaceExecute.residence"
        render={({ field }) => (
          <FormItem>
...
export default AffidavitOfSolemnizingAtPlaceExecute;
