...
> = ({ className }) => {
  ...
  const agreementA = useWatch({
    control,
    name: "affidavitForDelayed.a.a.agreement",
  });
  const agreementB = useWatch({
    control,
      ...
      {isDelayed === "Yes" && (
        <CardContent className="p-6">
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Affiant Information</CardTitle>
              </CardHeader>
              <CardContent>
                <NCRModeSwitch isNCRMode={affiant} setIsNCRMode={setAffiant} />
                    ...
                    <FormItem>
                      ...
                      <Select
                        onValueChange={(value) => {
                          ...
                          setValue(
                            "affidavitForDelayed.a.a.agreement",
                            isAffiantHusbandOrWife,
                            { shouldValidate: true }
                          );
                          setValue(
                            "affidavitForDelayed.a.b.agreement",
                            !isAffiantHusbandOrWife,
                            { shouldValidate: true }
                          );
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="false">
                            a. (the affiant is{" "}
                            <span className="text-red-500">not</span> the
                            husband or wife)
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="religious-ceremony">
                              Religious ceremony
                            </SelectItem>
                            <SelectItem value="civil-ceremony">
                              Civil ceremony
                            </SelectItem>
                            <SelectItem value="Muslim-rites">
                              Muslim rites
                            </SelectItem>
                            <SelectItem value="tribal-rites">
                              Tribal rites
                            </SelectItem>
                          </SelectContent>
                        </Select>
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  Reason for the delayed marriage registration
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6 space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>
                  Affidavit Execution (affiant address and issued date)
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6 space-y-6">
                <NCRModeSwitch
