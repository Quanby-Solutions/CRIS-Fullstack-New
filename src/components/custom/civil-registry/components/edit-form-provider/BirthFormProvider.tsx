...
export function EditBirthCivilRegistryFormInline({
  ...
  const mapToBirthCertificateValues = (
    ...
    if (
      ...
      if (
        ("signature" in rawPreparedBy &&
          typeof rawPreparedBy.signature === "string") ||
        ("nameInPrint" in rawPreparedBy &&
          typeof rawPreparedBy.nameInPrint === "string") ||
        ("titleOrPosition" in rawPreparedBy &&
          typeof rawPreparedBy.titleOrPosition === "string") ||
        ...
        "name" in rawPreparedBy &&
        typeof rawPreparedBy.name === "string"
      ) {
    ...
    const rawDelayedAffidavit =
      form.birthCertificateForm?.affidavitOfDelayedRegistration;
    ...
    return {
      ...
      receivedBy: {
        ...
        titleOrPosition:
          typeof form.receivedByPosition === "string"
            ? form.receivedByPosition
            : "",
      ...
      registeredByOffice: {
        ...
        titleOrPosition:
          typeof form.registeredByPosition === "string"
            ? form.registeredByPosition
            : "",
        date: parseDateSafely(form.registeredByDate),
      },

      hasAffidavitOfPaternity:
        form.birthCertificateForm?.hasAffidavitOfPaternity,
      affidavitOfPaternityDetails: {
        father: {
        ...
        adminOfficer: {
          ...
          titleOrPosition:
            affidavitOfPaternityDetails?.adminOfficer?.titleOrPosition || "",
          address: {
            country:
              affidavitOfPaternityDetails?.adminOfficer?.address?.country || "",
            barangay:
              affidavitOfPaternityDetails?.adminOfficer?.address?.barangay ||
              "",
            province:
        ...
        ctcInfo: {
          ...
          dateIssued:
            parseDateSafely(affidavitOfPaternityDetails?.ctcInfo?.dateIssued) ||
            "",
  ...
  const handleEditSubmit = async (
    ...
    const updatedForm = {
      ...
      motherInfo: {
        ...
        totalChildrenBornAlive: Number(
          data.motherInfo?.totalChildrenBornAlive ?? 0
        ),
      ...
      affidavitOfPaternityDetails: {
        ...
        adminOfficer: {
          nameInPrint:
            data.affidavitOfPaternityDetails?.adminOfficer?.nameInPrint || "",
          titleOrPosition:
            data.affidavitOfPaternityDetails?.adminOfficer?.titleOrPosition ||
            "",
          address: mergeResidence(
            originalAdminOfficerAddress,
            data.affidavitOfPaternityDetails?.adminOfficer?.address as Record<
              string,
              string
            >
          ),
        ...
        ctcInfo: {
          ...
          placeIssued:
            data.affidavitOfPaternityDetails?.ctcInfo?.placeIssued || "",
        },
      },
