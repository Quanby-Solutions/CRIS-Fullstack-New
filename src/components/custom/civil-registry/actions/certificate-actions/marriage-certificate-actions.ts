            ...
            async (tx) => {
                ...
                await tx.marriageCertificateForm.create({
                    data: {
                        ...
                        husbandDateOfBirth: formData.husbandBirth,
                        ...
                        wifeDateOfBirth: formData.wifeBirth,
                        ...
                        // Witnesses
                        witnesses: formData.husbandWitnesses,
                        ...
                        affidavitOfSolemnizingOfficer: formData.affidavitOfSolemnizingOfficer ? {
                            ...
                            a: {
                                nameOfHusband: formData.affidavitOfSolemnizingOfficer.a.nameOfHusband,
                                nameOfWife: formData.affidavitOfSolemnizingOfficer.a.nameOfWife,
                            },
                            b: {
                        ...
                        affidavitOfdelayedRegistration: formData.affidavitForDelayed?.delayedRegistration === 'Yes' ? {
                            ...
                            a: {
                                a: {
                                    ...
                                    dateOfMarriage: formData.affidavitForDelayed.a.a.dateOfMarriage ?
                                        dateToJSON(formData.affidavitForDelayed.a.a.dateOfMarriage) : null
                                },
                                b: {
                                    ...
                                    dateOfMarriage: formData.affidavitForDelayed.a.b.dateOfMarriage ?
                                        dateToJSON(formData.affidavitForDelayed.a.b.dateOfMarriage) : null
                                }
                            },
                            ...
                            f: {
                                date: formData.affidavitForDelayed.f.date ?
                                    dateToJSON(formData.affidavitForDelayed.f.date) : null,
                                place: {
